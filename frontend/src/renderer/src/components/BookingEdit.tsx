  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
        <div className="text-theme-text font-bold text-2xl tracking-tight">Editar reserva</div>
      ...
      <form onSubmit={updateBooking} className="space-y-6 md:space-y-8">
          <motion.div 
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              <div className="flex flex-col gap-2">
                ...
                <input type="text" name="first_name" value={form.first_name} onChange={handleChange} required className="px-4 py-3 rounded-xl bg-theme-background/30 text-theme-text border border-theme-border focus:outline-none focus:ring-2 focus:ring-theme-accent/40 transition text-sm" placeholder="Primer nombre" />
              </div>
              <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input type="text" name="address" value={form.address} onChange={handleChange} required className="px-4 py-3 rounded-xl bg-theme-background/30 text-theme-text border border-theme-border focus:outline-none focus:ring-2 focus:ring-theme-accent/40 transition text-sm" placeholder="Calle y número" />
              </div>
              <div className="flex flex-col gap-2">
                <label className="text-theme-textSecondary text-[10px] uppercase tracking-widest font-bold ml-1">Teléfono</label>
                <input type="text" name="phone" value={form.phone} onChange={handleChange} required className="px-4 py-3 rounded-xl bg-theme-background/30 text-theme-text border border-theme-border focus:outline-none focus:ring-2 focus:ring-theme-accent/40 transition text-sm" placeholder="+123456789" />
              </div>
              <div className="flex flex-col gap-2">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              <div className="flex flex-col gap-2">
                ...
                <input type="text" name="hotel_name" value={form.hotel_name} onChange={handleChange} required className="px-4 py-3 rounded-xl bg-theme-background/30 text-theme-text border border-theme-border focus:outline-none focus:ring-2 focus:ring-theme-accent/40 transition text-sm" placeholder="Nombre del hotel" />
              </div>
              <div className="flex flex-col gap-2">
                <label className="text-theme-textSecondary text-[10px] uppercase tracking-widest font-bold ml-1">Tipo de habitación</label>
                <input type="text" name="room_type" value={form.room_type} onChange={handleChange} className="px-4 py-3 rounded-xl bg-theme-background/30 text-theme-text border border-theme-border focus:outline-none focus:ring-2 focus:ring-theme-accent/40 transition text-sm" placeholder="Ej: individual, doble, suite" />
              </div>
              <div className="flex flex-col gap-2">
                <label className="text-theme-textSecondary text-[10px] uppercase tracking-widest font-bold ml-1">Ubicación</label>
                <input type="text" name="location" value={form.location} onChange={handleChange} required className="px-4 py-3 rounded-xl bg-theme-background/30 text-theme-text border border-theme-border focus:outline-none focus:ring-2 focus:ring-theme-accent/40 transition text-sm" placeholder="Ciudad, país" />
              </div>
            </div>
          </motion.div>
                  ...
                  {firstPreview && (
                    <>
                      ...
                      <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2 backdrop-blur-sm">
                        ...
                        {form.first_image && (
                          <button type="button" onClick={(ev) => { ev.stopPropagation(); removeImage('first_image'); }} className="px-3 py-1.5 text-xs font-bold rounded-lg bg-red-600 text-white hover:bg-red-700 transition-all">Deshacer</button>
                        )}
                      </div>
                    </>
                  )}
                  ...
                  {secondPreview && (
                    <>
                      ...
                      <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2 backdrop-blur-sm">
                        ...
                        {form.second_image && (
                          <button type="button" onClick={(ev) => { ev.stopPropagation(); removeImage('second_image'); }} className="px-3 py-1.5 text-xs font-bold rounded-lg bg-red-600 text-white hover:bg-red-700 transition-all">Deshacer</button>
                        )}
                      </div>
                    </>
                  )}
